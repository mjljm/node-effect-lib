...
export interface ServiceInterface {
	...
	/**
	 * Get information about a path. Does not follow symbolic links. Does not work at the moment. To be updated when Platform node has been corrected.
	 */
	...
	/**
	 * Reads the contents of the directory at path and of all directories (including symlinks) below except these excluded by excludeDir. Returns an error if circularity is detected. If glob receives a relative path, excludeDir will receive a relative path as well. If glob receives an absolute path, excludeDir will receive an absolute path as well.
	 */
	...
	/**
	 * Reads the directory tree upward starting at path until either isTargetDir returns true or the user's home directory is reached.
